	<header id="header" class="tra-menu navbar-light white-scroll">
				<div class="header-wrapper">
				    ...
				    <div class="wsmobileheader clearfix">	  	
				    	<span class="smllogo"><img src="podologue.mu/images/aglae-logo-dark.webp" alt="mobile-logo"></span>
				  	...
				  	<div class="wsmainfull menu clearfix">
	    				<div class="wsmainwp clearfix">
	    					...
	    					<div class="desktoplogo">
	    						<a href="/home" class="logo-black"><img src="podologue.mu/images/aglae-logo-dark.webp" alt="logo"></a>
	    					</div>


	    					<!-- AGLAE-PROVOST-FLEURY-PODOLOGUE.MU HEADER WHITE LOGO -->
	    					<div class="desktoplogo">
	    						<a href="/home" class="logo-white"><img src="podologue.mu/images/logo-white.svg" alt="logo"></a>
	    					</div>
	      					...
	      					<nav class="wsmenu clearfix">
	        					<ul class="wsmenu-list nav-theme">
									...
									<!-- SIMPLE NAVIGATION LINK -->
							    		{{-- <li aria-haspopup="true"><a href="#" class="h-link">{{ __('Service') }} <span class="wsarrow"></span></a>
	            						<ul class="sub-menu">
	            							<li aria-haspopup="true"><a href="/podiatry">{{ __('Podiatry Assessment') }}</a></li>
	            							<li aria-haspopup="true"><a href="/pedicure">{{ __('Medical Pedicure') }}</a></li>
											<li aria-haspopup="true"><a href="/semelle">{{ __('Orthopedic insoles') }}</a></li>
						           		</ul>
								    </li> --}}
