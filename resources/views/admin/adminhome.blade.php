...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <meta charset="utf-8" />
    <title>Aglaë Provost-Fleury | Podologue Dashboard</title>
    ...
    <!-- App favicon -->
        <link rel="shortcut icon" href="/admin/assets/images/favicon.ico">
            ...
            <!-- Vector Map css -->
            <link rel="stylesheet" href="/admin/assets/vendor/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.css">
            <!-- Theme Config Js -->
...
<!-- @@include('./horizontal-nav.html') -->
                                    ...
                                    <div class="col-sm-6">
                                        <div class="card widget-flat">
                                            <div class="card-body">
                                                ...
                                                <h5 class="text-muted fw-normal mt-0" title="Number of Customers">{{ __('Patient') }}</h5>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="card widget-flat">
                                            <div class="card-body">
                                                ...
                                                <h5 class="text-muted fw-normal mt-0" title="Number of Orders">{{ __('Appointments') }}</h5>
                                                <h3 class="mt-3 mb-3">-</h3>
                                                <p class="mb-0 text-muted">
                                                </p>
                                            </div> <!-- end card-body-->
                                    ...
                                    <div class="col-sm-6">
                                        <div class="card widget-flat">
                                            <div class="card-body">
                                                ...
                                                <h5 class="text-muted fw-normal mt-0" title="Average Revenue">{{ __('Revenue') }}</h5>
                                                <h3 class="mt-3 mb-3">-</h3>
                                                <p class="mb-0 text-muted">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="card widget-flat">
                                            <div class="card-body">
                                                ...
                                                <h5 class="text-muted fw-normal mt-0" title="Growth">{{ __('Growth') }}</h5>
                                                <h3 class="mt-3 mb-3">-</h3>
                                                <p class="mb-0 text-muted">
                            ...
                            <div class="col-xl-7 col-lg-6">
                                <div class="card card-h-100">
                                    <div class="d-flex card-header justify-content-between align-items-center">
                                        <h4 class="header-title">{{ __('Analytics') }}</h4>
                                        <div class="dropdown">
        ...
        <!-- Vector Map js -->
        <script src="/admin/assets/vendor/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.min.js"></script>
        <script src="/admin/assets/vendor/admin-resources/jquery.vectormap/maps/jquery-jvectormap-world-mill-en.js"></script>
