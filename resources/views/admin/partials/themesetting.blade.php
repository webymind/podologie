            ...
            <div class="offcanvas-body p-0">
                <div data-simplebar class="h-100">
                    <div class="card mb-0 p-3">
                        <h5 class="mt-0 font-16 fw-bold mb-3">{{ __('Choose Layout') }}</h5>
                        <div class="row">
                            <div class="col-4">
                                ...
                                <h5 class="font-14 text-center text-muted mt-2">{{ __('Vertical') }}</h5>
                            </div>
                            <div class="col-4">
                                <div class="form-check card-radio">
                                ...
                                <h5 class="font-14 text-center text-muted mt-2">{{ __('Horizontal') }}</h5>
                            </div>
                        </div>

                        <h5 class="my-3 font-16 fw-bold">{{ __('Color Scheme') }}</h5>
                        ...
                        <div id="sidebar-size">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    ...
                                    <h5 class="font-14 text-center text-muted mt-2">{{ __('Hover View') }}</h5>
                                </div>
                        ...
                        <div id="sidebar-user">
                            <div class="d-flex justify-content-between align-items-center mt-3">
                                <label class="font-16 fw-bold m-0" for="sidebaruser-check">{{ __('Sidebar User Info') }}</label>
